                ...
                return (
                    <div ref={stepRef} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-blue-500 transition-colors"
                                value={jobSpec.image}
                        ...
                        <button
                            onClick={nextStep}
                            className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 rounded-lg transition-all mt-4"
                        >
                ...
                return (
                    <div ref={stepRef} className="space-y-6">
                        ...
                        <div className="flex space-x-3">
                            ...
                            >
                                {loading ? "Broadcasting..." : "Confirm & Launch"}
                            </button>
                        </div>
                    </div>
                );
